...
# In this file the information needed to create new student accounts will be contained. This information will consist of a user name, first name and last name on one line, and a password on the next line. 
